...
import { generateRecipePDF, shareContent } from '../utils/exportUtils';
    ...
    return (
        <div className="grow container mx-auto px-4 py-8 max-w-5xl">
            ...
            <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10 pb-6 border-b-4 border-[#392f28] border-dashed">
                <div>
                    <h1 className="text-4xl md:text-5xl font-black text-[#3E2723] dark:text-white mb-2 tracking-tight drop-shadow-sm">{title}</h1>
                ...
                <div className="flex flex-wrap gap-3">
                    ...
                    {/* imprimir , compartir y descargar*/}
                    {/* <button 
                        onClick={() => window.print()}
                        className="flex items-center gap-2 text-[#ffffff] bg-[#f8f7f6] dark:bg-[#28211d] border-2 border-black dark:border-[#5D4037] px-4 py-2 rounded-lg shadow-retro-sm hover:translate-y-[2px] hover:shadow-none transition-all font-bold uppercase text-sm group"
                    >
                        <span translate="no" className="material-symbols-outlined notranslate text-primary group-hover:scale-110 transition-transform">print</span>
                        <span className="text-black dark:text-[#b9a89d]">Imprimir</span>
                    </button> */}
                    <button 
                        onClick={() => shareContent(title, window.location.href)}
                        className="flex items-center gap-2 text-[#ffffff] bg-[#f8f7f6] dark:bg-[#28211d] border-2 border-black dark:border-[#5D4037] px-4 py-2 rounded-lg shadow-retro-sm hover:translate-y-[2px] hover:shadow-none transition-all font-bold uppercase text-sm group"
                    >
                        <span translate="no" className="material-symbols-outlined notranslate text-primary group-hover:scale-110 transition-transform">share</span>
                        <span className="text-black dark:text-[#b9a89d]">Compartir</span>
                    </button>
                    <button 
                        onClick={() => generateRecipePDF(activeRecipe)}
                        className="flex items-center gap-2 text-[#ffffff] bg-[#f8f7f6] dark:bg-[#28211d] border-2 border-black dark:border-[#5D4037] px-4 py-2 rounded-lg shadow-retro-sm hover:translate-y-[2px] hover:shadow-none transition-all font-bold uppercase text-sm group"
                    >
                        <span translate="no" className="material-symbols-outlined notranslate text-primary group-hover:scale-110 transition-transform">download</span>
                        <span className="text-black dark:text-[#b9a89d]">Descargar </span>
                    </button>
                </div>
            </header>
            ...
            <section className="mt-20 pt-10 border-t-4 border-[#392f28] border-dashed">
                <div className="flex flex-col lg:flex-row gap-12">
                    <div className="flex-1">
                        <h3 className="text-3xl font-black text-[#181411] dark:text-white mb-8 flex items-center gap-3 italic">
